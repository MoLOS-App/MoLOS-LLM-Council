...
export class SettingsRepository {
	...
	async update(userId: string, input: UpdateSettingsInput): Promise<CouncilSettings> {
		try {
			...
			if (input.maxTokensStage1 !== undefined) updateData.maxTokensStage1 = input.maxTokensStage1;
			if (input.maxTokensStage2 !== undefined) updateData.maxTokensStage2 = input.maxTokensStage2;
			if (input.maxTokensStage3 !== undefined) updateData.maxTokensStage3 = input.maxTokensStage3;
	...
	async upsert(userId: string, input: UpdateSettingsInput): Promise<CouncilSettings> {
		try {
			...
			if (input.maxTokensStage1 !== undefined) insertData.maxTokensStage1 = input.maxTokensStage1;
			if (input.maxTokensStage2 !== undefined) insertData.maxTokensStage2 = input.maxTokensStage2;
			if (input.maxTokensStage3 !== undefined) insertData.maxTokensStage3 = input.maxTokensStage3;
			if (input.streamingEnabled !== undefined)
