...
export const DEFAULT_SYSTEM_PERSONAS = {
	CHAIRMAN: {
		...
		description: 'The official MoLOS council chairman - provides structure and synthesis',
		avatar: '👑',
		personalityPrompt:
	...
	MEMBER: {
		...
		description: 'A standard MoLOS council member - provides thoughtful analysis',
		avatar: '🎭',
		personalityPrompt:
